...
<html lang="en">
    ...
    <%
        ...
        ArrayList<Cita> lstCita = Daocit.BuscarCitaRealizada(Date.valueOf(request.getParameter("txtFecha")));
        int ganancia=0;
        %>
    <body>
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%= cit.getPrecio()%></td>
                                <% ganancia = ganancia + cit.getPrecio(); %>
                            </tr>
                            <% }%>
                        </tbody>
                    </table>
                    <br />  
                        <h1>Total Ganancias Obtenidas: <%= ganancia%></h1>
                </div>
            </div>
        </div>
