...
<html lang="en">
    ...
    <%
        ArrayList<Cita> lstCita = (ArrayList) request.getAttribute("citas");
        %>
    <body>
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="confirmarCita?fecha=<%= cit.getFecha()%>&hora=<%= cit.getHora()%>&cliente=<%= cit.getCliente()%>&empleado=<%= cit.getEmpleado()%>&req=<%= cit.getRequerimiento()%>&op=confirmaCita">Confirmar Atencion</a>
                              </td>                
                            </tr>
                            <% }%>
                        </tbody>
