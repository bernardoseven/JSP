...
<html lang="en">
    ...
    <%
        ...
        ArrayList<Cita> lstCita = Daocit.ListaCitaConfirmada();
        %>
    <body>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%= cit.getRequerimiento()%></td>
                                                                <td><a href="realizarAtencion?fecha=<%= cit.getFecha()%>&hora=<%= cit.getHora()%>&cliente=<%= cit.getCliente()%>&empleado=<%= cit.getEmpleado()%>&req=<%= cit.getRequerimiento()%>&op=realizaCita">Realizar Atencion</a>
                              </td>                
                            </tr>
                            <% }%>
                        </tbody>
